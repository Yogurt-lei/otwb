...
import com.yogurt.utils.common.callback.MethodCallback;
import com.yogurt.utils.common.lang.DateUtils;
...
//		if (ef != null && (ef.type()==0 || ef.type()==type)){
     ...
     * @param groups 导入分组
     */
    public <E> List<E> getDataList(Class<E> cls, String... groups) throws InstantiationException,
     ...
     * @param groups           导入分组
     */
    public <E> List<E> getDataList(Class<E> cls, final boolean isThrowException, String... groups) throws
     ...
     * @param groups 导入分组
     */
    public <E> List<E> getDataList(Class<E> cls, MethodCallback exceptionCallback, String... groups) throws
            InstantiationException, IllegalAccessException {
                            ...
                            if (valType == String.class) {
                                ...
                                if (ef.fieldType() != Class.class) {
                                    ...
                                    val = Class.forName(this.getClass().getName().replaceAll(this.getClass()
                                            ...
                                            String.class).invoke(null, val.toString());
                                }
                            }
                        }
                    } catch (Exception ex) {
