...
public class FullyQualifiedTable {
    ...
    public FullyQualifiedTable(String introspectedCatalog,
        ...
        // bug fixed 使配置的table/domainObjectRenamingRule起作用 官方的jar还没修复
        if (domainObjectRenamingRule != null) {
            ...
            Matcher matcher = pattern.matcher(introspectedTableName);

            // 这里把domainObjectName直接先写入就ok啦
            // 先把替换的去掉 然后下划线转驼峰风格
            String matcherString = matcher.replaceAll(replaceString);
            this.domainObjectName = underlineToCamel(matcherString);
        }
